...
use EBoost\Menu\Model\Menu\Node\Image\File as ImageFile;
use EBoost\Menu\Model\NodeTypeProvider;
...
class Menu extends Template implements DataObject\IdentityInterface
{
     ...
     * @var string
     */
    protected $_template = 'EBoost_Menu::menu.phtml';

    /**
     * @var string
     */
    protected $baseSubmenuTemplate = 'EBoost_Menu::menu/sub_menu.phtml';
    ...
    {
        return [
            \EBoost\Menu\Model\Menu::CACHE_TAG . '_' . $this->loadMenu()->getId(),
            Block::CACHE_TAG,
            \EBoost\Menu\Model\Menu::CACHE_TAG
        ];
    }
    ...
    /**
     * @return \EBoost\Menu\Model\Menu|null
     */
    ...
    /**
     * @param string $nodeType
     * @return \EBoost\Menu\Api\NodeTypeInterface
     */
    ...
    private function getSubmenuBlock($nodes, $parentNode, $level = 0)
    {
        ...
        $submenuTemplate = $submenuTemplate
            ? 'EBoost_Menu::' . $this->getMenu()->getIdentifier() . "/menu/custom/sub_menu/{$submenuTemplate}.phtml"
