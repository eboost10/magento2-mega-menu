...
namespace EBoost\Menu\Block\Adminhtml\Edit\Tab;

use Magento\Backend\Block\Template;
use Magento\Backend\Block\Widget\Tab\TabInterface;
use Magento\Framework\Registry;
use EBoost\Menu\Api\NodeRepositoryInterface;
use EBoost\Menu\Controller\Adminhtml\Menu\Edit;
use EBoost\Menu\Model\Menu\Node\Image\File as ImageFile;
use EBoost\Menu\Model\NodeTypeProvider;
use EBoost\Menu\Model\VueProvider;

class Nodes extends Template implements TabInterface
{
    const IMAGE_UPLOAD_URL = 'eboostmenu/node/uploadimage';
    const IMAGE_DELETE_URL = 'eboostmenu/node/deleteimage';
