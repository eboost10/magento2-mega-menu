...
namespace EBoost\Menu\Ui\Component\Listing\Column\MenuList;
...
class PageActions extends Column
{
     ...
     * Url path
     */
    const URL_PATH_EDIT = 'eboostmenu/menu/edit';
    const URL_PATH_DELETE = 'eboostmenu/menu/delete';
    const URL_PATH_STATUS = 'eboostmenu/menu/status';
    const URL_PATH_DUPLICATE = 'eboostmenu/menu/duplicate';
    const URL_PATH_EXPORT = 'eboostmenu/menu/export';
