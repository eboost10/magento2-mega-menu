...
namespace EBoost\Menu\Ui\DataProvider\Menu\Form\Modifier;
...
class ImportCategories implements ModifierInterface
{
    ...
    {
        return true; // (bool) $this->authorization->isAllowed('Magento_Catalog::categories');
    }
                                ...
                                'config' => [
                                    ...
                                    'render_url' => $this->urlBuilder->getUrl(
                                        ...
                                        [
                                            ...
                                            'store' => 0, //$this->locator->getStore()->getId(),
                                            'buttons' => 1
                                        ]
                                    ),
                                    'autoRender' => false,
    ...
    protected function customizeCategoriesField(array $meta)
    {
        ...
        $fieldIsDisabled = false; //$this->locator->getProduct()->isLockedAttribute($fieldCode);
                ...
                'arguments' => [
                    'data' => [
                        'config' => [
                            ...
                            'actions' => [
                                [
                                    'targetName' => 'eboostmenu_menu_form.eboostmenu_menu_form.create_category_modal',
                                    'actionName' => 'toggleModal',
                                ],
                                [
                                    'targetName' =>
                                        'eboostmenu_menu_form.eboostmenu_menu_form.create_category_modal.create_category',
                                    'actionName' => 'render'
                                ],
                                [
                                    'targetName' =>
