...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    private function addMenuCssClassField(SchemaSetupInterface $setup)
    {
        $setup->getConnection()->addColumn(
            $setup->getTable('eboostmenu_menu'),
            'css_class',
            [
    ...
    private function changeTitleType(SchemaSetupInterface $setup)
    {
        $setup->getConnection()->modifyColumn(
            $setup->getTable('eboostmenu_node'),
            'title',
            [
                'type' => Table::TYPE_TEXT,
                'nullable' => false
    ...
    {
        $table = $setup->getTable('eboostmenu_node');
    ...
    {
        $menuTable = $setup->getTable('eboostmenu_menu');
        $nodeTable = $setup->getTable('eboostmenu_node');
        $storeTable = $setup->getTable('eboostmenu_store');
        $setup->getConnection()->modifyColumn(
            $nodeTable,
            'menu_id',
            [
