...
{
    const CACHE_TAG = 'EBoost_menu_menu';

    protected $_cacheTag = self::CACHE_TAG;

    protected function _construct()
    {
        $this->_init(\EBoost\Menu\Model\ResourceModel\Menu::class);
    }
    ...
    public function getStores()
    {
        ...
        $select = $connection->select()->from($this->getResource()->getTable('eboostmenu_store'), ['store_id'])->where(
            'menu_id = ?',
            $this->getId()
        );
    ...
    public function saveStores(array $stores)
    {
        ...
        $table = $this->getResource()->getTable('eboostmenu_store');
     ...
     * @inheritdoc
     */
    public function setNodeCssClass($nodeCssClass)
    {
        return $this->setData(MenuInterface::NODE_CSS_CLASS, $nodeCssClass);
    }
    ...
    {
        return $this->_getData(MenuInterface::NODE_CSS_CLASS);
    }
